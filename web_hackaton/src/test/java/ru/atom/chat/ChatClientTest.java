...
public class ChatClientTest {
    ...
    public void signup() throws IOException {
        ...
        System.out.println();
        Assert.assertTrue(response.code() == 200 || body.equals("This user already exists"));
    }
    ...
    public void login() throws IOException {
        ...
        String body = response.body().string();
        System.out.println();
        Assert.assertTrue(response.code() == 200 || body
                .equals("This user doesn't exists") || body.equals("Already logged in."));
    }
